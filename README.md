...
2. ****Beta builds may contain destructive changes from build to build.**** Therefore I strongly recommend against working on anything critical on beta builds. If you want to live on the edge, please carefully read the [changelog](CHANGELOG.md) before each update. You can also try out development builds [here](https://downloads.junes.website/machinedrum/dev/latest.syx), for testing only.
